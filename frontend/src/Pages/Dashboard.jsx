    ...
    <div className={`premium-dashboard ${mounted ? 'mounted' : ''}`}>
      ...
      <div className="relative z-10 p-8 max-w-7xl mx-auto">
        ...
        <div className="text-center py-16 pb-12 animate-slide-up-large animation-delay-200">
          ...
          <div className="text-base text-white/60 max-w-2xl mx-auto mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 my-12 animate-slide-up-large animation-delay-400">
          {[
            { icon: '🌍', number: '140', label: 'Countries' },    
            { icon: '🎮', number: '2', label: 'Game Modes' },
            { icon: '❓', number: '15', label: 'Questions' },
            { icon: '⏱️', number: '30s', label: 'Per Question' }
          ].map((stat, index) => (
            <div 
              key={index}
        ...
        <div className="my-16 animate-slide-up-large animation-delay-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {gameModes.map((gameMode, index) => (
              <div
                key={gameMode.name}
                className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 transition-all duration-500 hover:-translate-y-3 hover:bg-white/8 hover:border-white/20 hover:shadow-2xl hover:shadow-black/30 overflow-hidden max-w-md mx-auto"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Replace the old button with LaunchButton */}
                  <div className="flex justify-center">
<LaunchButton
  text="Play"
  size="small"
  variant={gameMode.buttonVariant}
  narrow={true} // Makes it narrower
  onClick={(e) => {
