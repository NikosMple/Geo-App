  ...
  return (
    <>
      <style jsx>{`
        ...
        .hourglass-timer.running .loader__glare-top,
        .hourglass-timer.running .loader__glare-bottom,
        .hourglass-timer.running .loader__model,
        .hourglass-timer.running .loader__motion-thick,
        .hourglass-timer.running .loader__motion-medium,
        .hourglass-timer.running .loader__motion-thin,
        .hourglass-timer.running .loader__sand-drop,
        .hourglass-timer.running .loader__sand-fill,
        .hourglass-timer.running .loader__sand-grain-left,
        .hourglass-timer.running .loader__sand-grain-right,
        .hourglass-timer.running .loader__sand-line-left,
        .hourglass-timer.running .loader__sand-line-right,
        .hourglass-timer.running .loader__sand-mound-top,
        .hourglass-timer.running .loader__sand-mound-bottom {
      ...
      <div className={`flex items-center gap-3 bg-white/10 backdrop-blur-lg border border-white/20 px-4 py-2 rounded-full text-white font-medium transition-all duration-300 ${
        isVeryLowTime ? 'bg-red-500/30 border-red-400 animate-pulse scale-110' : 
        isLowTime ? 'bg-red-500/20 border-red-400 animate-pulse' : ''
      }`}>
        
        {/* Hourglass SVG */}
        <div className={`transition-all duration-300 ${isLowTime ? 'animate-bounce' : ''}`}>
          <svg
            aria-label="timer hourglass"
            role="img"
            height="24px"
            width="24px"
            viewBox="0 0 56 56"
            className={`hourglass-timer ${isRunning ? 'running' : 'paused'}`}
            style={{
              filter: isVeryLowTime ? 'drop-shadow(0 0 8px #ef4444)' : 
                     isLowTime ? 'drop-shadow(0 0 4px #f59e0b)' : 
            ...
            <g transform="translate(2,2)">
              ...
              <g transform="translate(13.75,9.25)" className="loader__model">
                <path
                  ...
                  fill={isVeryLowTime ? "#ef4444" : isLowTime ? "#f59e0b" : "#3b82f6"}
                  opacity="0.8"
                />
                ...
                <rect height="2" width="24.5" fill={isVeryLowTime ? "#dc2626" : isLowTime ? "#d97706" : "#2563eb"} />
                <rect
                  height="1"
                  width="19.5"
                  y="0.5"
                ...
                <rect
                  ...
                  width="24.5"
                  y="31.5"
                  fill={isVeryLowTime ? "#dc2626" : isLowTime ? "#d97706" : "#2563eb"}
                />
                <rect
                  height="1"
                  width="19.5"
        ...
        <span className={`font-mono text-lg font-bold transition-all duration-300 ${
          isVeryLowTime ? 'text-red-200 text-xl' : 
        ...
        {/* Status indicator */}
        {isVeryLowTime && (
          <span className="text-red-300 text-xs animate-pulse font-bold">
            HURRY!
          </span>
        )}
      </div>
